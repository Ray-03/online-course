...
class ExploreCourse extends StatefulWidget {
  @override
  _ExploreCourseState createState() => _ExploreCourseState();
}

class _ExploreCourseState extends State<ExploreCourse> {
  final List<Tab> courseCategory = CourseCategory.values
      .map(
        (e) => Tab(
          child: Chip(
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: CourseCategory.values.length,
      child: Column(
        children: [
          TabBar(
            tabs: courseCategory,
          ...
          Expanded(
            flex: 1,
            child: TabBarView(
              children: courseInExplore.entries
                  .map(
                    (e) => GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        Course courseIter = e.value.keys.elementAt(index);
